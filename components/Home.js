...
var Home = function Home() {
  return /*#__PURE__*/React.createElement("div", {
    id: "Home"
  }, /*#__PURE__*/React.createElement(_reactParallax.Parallax, {
    className: "w-full h-screen ",
    style: {
      backgroundColor: '#37323E'
    },
    strength: 800
  }, /*#__PURE__*/React.createElement(_reactParallax.Background, {
    className: "w-full h-screen"
    ...
    className: "w-56 h-auto m-0  mt-10 pt-10 hidden sm:block",
    style: {
      marginLeft: '-80px'
    }
    ...
    className: "w-40 h-auto p-0 pl-20",
    style: {
      marginTop: '-120px'
    }
  }, /*#__PURE__*/React.createElement("img", {
    ...
    className: "flex flex-col items-center justify-center pt-40 pl-30 w-full"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex justify-center w-full font-opensans font-normal lg:text-xl md:text-sm sm:text-xs",
    style: {
      letterSpacing: '0.8em',
      color: '#BFBDC1'
    }
  }, "SONAM RANI"), /*#__PURE__*/React.createElement("div", {
    className: "flex justify-center w-full font-sans font-black   lg:text-8xl lg:mb-[-25px]   md:text-7xl md:mb-[-20px]   sm:text-7xl sm:mb-[-20px]   text-3xl mb-[-12px] ",
    style: {
      color: '#DEB841'
    }
    ...
    className: "flex justify-center w-full font-sans font-black lg:text-8xl md:text-7xl sm:text-7xl text-3xl",
    style: {
      color: '#DEB841'
    }
...
var _default = exports["default"] = Home; // import React from 'react'
// function Home() {
//   return (
//       <>
